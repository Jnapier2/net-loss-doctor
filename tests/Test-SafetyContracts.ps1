...
Assert-True ($publicMetadata.release_framework_version -eq '2.17.9') 'Release framework is not aligned to 2.17.9.'
Assert-True ($publicMetadata.release_framework_sha256 -eq 'fafe3f4a972b1f4def6e10faee7febc3c75154b8b346949991bb9d86e8a610df') 'Release framework checksum changed.'
